...
from ansible_collections.nikitamishagin.eltex_mes.plugins.modules import ios_lldp_global
...
class TestIosLldpGlobalModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.ios.facts.lldp_global.lldp_global."
