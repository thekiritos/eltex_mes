...
from ansible_collections.nikitamishagin.eltex_mes.plugins.modules import ios_evpn_evi
...
class TestIosEvpnEviModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.ios.facts.evpn_evi.evpn_evi."
