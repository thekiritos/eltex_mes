...
from ansible_collections.nikitamishagin.eltex_mes.plugins.modules import mes_lldp_global
...
class TestIosLldpGlobalModule(TestMesModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.facts.lldp_global.lldp_global."
