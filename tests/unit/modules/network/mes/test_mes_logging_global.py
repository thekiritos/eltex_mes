...
from ansible_collections.nikitamishagin.eltex_mes.plugins.modules import mes_logging_global
...
class TestIosLoggingGlobalModule(TestMesModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.facts.logging_global.logging_global."
