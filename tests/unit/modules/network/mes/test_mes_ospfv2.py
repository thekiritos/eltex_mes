...
from ansible_collections.nikitamishagin.eltex_mes.plugins.modules import mes_ospfv2
...
class TestIosOspfV2Module(TestMesModule):
    module = mes_ospfv2
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch(
            "ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.facts.ospfv2.ospfv2."
    ...
    def test_ios_ospfv2_overridden(self):
        ...
        commands = [
            ...
            "max-metric router-lsa include-stub summary-lsa 20 external-lsa 10 on-startup 110",
            "maximum-paths 15",
