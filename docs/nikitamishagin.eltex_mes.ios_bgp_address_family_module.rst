.. _nikitamishagin.eltex_mes.ios_bgp_address_family_module:


***********************************************
nikitamishagin.eltex_mes.ios_bgp_address_family
***********************************************
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Filter updates to/from this neighbor</div>
                        <div>This option is DEPRECATED and is replaced with prefix_lists which accepts list of dict as input</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>This option is DEPRECATED and is replaced with route_maps which accepts list of dict as input</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>Maintains backwards compatibility for configurations that do not specify a send-community type.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Redistribute automatically established IP connected routes.</div>
                        <div>This only needs to be set if metric or route_map aren&#x27;t used.</div>
                </td>
            </tr>
