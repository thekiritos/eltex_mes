.. _nikitamishagin.eltex_mes.mes_cliconf:


****************************
nikitamishagin.eltex_mes.mes
****************************

**Use mes cliconf to run commands on Eltex MES platform**
...
Synopsis
--------
- This mes plugin provides low-level abstraction APIs for sending and receiving CLI commands from Eltex MES network devices.
        ...
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <td>
                                <div>var: ansible_mes_config_commands</div>
                    </td>
                <td>
