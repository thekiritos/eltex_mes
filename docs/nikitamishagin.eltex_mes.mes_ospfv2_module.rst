    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Set external-lsa metric with max-metric value without metirc value</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set summary-lsa metric with max-metric value without metirc value</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
     ...
     of the parameters above.</div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                        <div style="font-size: smaller"><b>Sample:</b></div>
                        <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">[&#x27;router ospf 200 vrf blue&#x27;, &#x27;auto-cost reference-bandwidth 4&#x27;, &#x27;distribute-list 10 out&#x27;]</div>
                </td>
            </tr>
    </table>
    <br/><br/>
