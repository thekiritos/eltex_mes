...
"""
The module file for mes_l2_interfaces
"""
...
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.config.l2_interfaces.l2_interfaces import (
    L2_interfaces,
)
