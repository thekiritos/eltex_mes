...
"""
The mes logging_global fact class
...
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.argspec.logging_global.logging_global import (
    Logging_globalArgs,
)
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.rm_templates.logging_global import (
    Logging_globalTemplate,
)


class Logging_globalFacts(object):
    """The mes logging_global facts class"""
