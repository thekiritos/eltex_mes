...
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.ios.argspec.hostname.hostname import (
    HostnameArgs,
)
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.ios.rm_templates.hostname import (
    HostnameTemplate,
)
