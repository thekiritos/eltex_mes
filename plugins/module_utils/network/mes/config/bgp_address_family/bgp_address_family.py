...
"""
The mes bgp_address_family config file.
...
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.rm_templates.bgp_address_family import (
...
class Bgp_address_family(ResourceModule):
    """
    The mes bgp_address_family config class
    """
