...
"""
The mes vxlan_vtep config file.
...
from ansible_collections.nikitamishagin.eltex_mes.plugins.module_utils.network.mes.rm_templates.vxlan_vtep import (
    Vxlan_vtepTemplate,
)
...
class Vxlan_vtep(ResourceModule):
    """
    The mes vxlan_vtep config class
    """
